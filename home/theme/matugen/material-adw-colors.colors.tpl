# MaterialAdw semantic KDE color scheme, adapted from InioX/matugen-themes.
# The file name is stable so Dolphin can keep one [UiSettings] ColorScheme key
# while Darkman/Matugen replace the values for each mode.
...
[General]
ColorScheme=MaterialAdwMatugen
Name=MaterialAdw (Matugen)

[Appearance]
color_scheme=MaterialAdwMatugen
